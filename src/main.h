...
static const int64 MAX_MONEY = 84000000 * COIN; // NetCent: maximum of 840k coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 576 / 250; // NetCent: 576 blocks found a day. Priority cutoff is 1 NetCent day / 250 bytes.
    }
